...
- Argo Project. (n.d.). _[Argo Rollouts](https://argoproj.github.io/argo-rollouts/)_ [Documentation].
- DevOps Toolkit. (n.d.). _[Progressive delivery with Argo Rollouts: canary deployments](https://www.youtube.com/watch?v=tnB0TwEqNFA&t=958s)_ [Video]. YouTube.

---

<div class="alert alert-no"><strong>🇲🇾 Happy Merdeka Day!</strong> Malaysia celebrates 68 years of independence today!</div>
