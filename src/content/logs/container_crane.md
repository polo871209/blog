...
<div class="alert"><strong>Disclaimer:</strong> While <code>crane</code> is a stable and production-ready tool, the go-containerregistry repository doesn't appear to be actively maintained with frequent updates. The tool works reliably for current use cases, but consider this when planning long-term dependencies.</div>

---

## References

- Google. (n.d.). _[crane documentation](https://github.com/google/go-containerregistry/blob/main/cmd/crane/doc/crane.md)_ [Documentation]. GitHub.
- Google. (n.d.). _[crane recipes and examples](https://github.com/google/go-containerregistry/blob/main/cmd/crane/recipes.md)_ [Documentation]. GitHub.
- Google. (n.d.). _[go-containerregistry](https://github.com/google/go-containerregistry)_ [Computer software]. GitHub.
