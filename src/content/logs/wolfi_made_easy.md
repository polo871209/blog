...
- Chainguard. (n.d.). _[Wolfi overview](https://edu.chainguard.dev/open-source/wolfi/overview/)_ [Documentation].
- Google. (n.d.). _[distroless](https://github.com/GoogleContainerTools/distroless)_ [Computer software]. GitHub.
- Lo, P. (n.d.). _[Understanding Bazel with distroless](../understanding_bazel_with_distroless)_.
- Wolfi. (n.d.). _[Wolfi OS package repository](https://github.com/wolfi-dev/os)_ [Source code]. GitHub.
- Wolfi. (n.d.). _[Wolfi security advisories](https://github.com/wolfi-dev/advisories)_ [Source code]. GitHub.
