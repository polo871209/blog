...
- eBPF Foundation. (n.d.). _[eBPF documentation](https://ebpf.io/)_ [Documentation].
- Cilium Authors. (n.d.). _[Cilium documentation](https://docs.cilium.io/)_ [Documentation].
- Adebayo, A. (n.d.). _[Now let's talk about Cilium and how it leverages eBPF](https://medium.com/@addeybob/now-lets-talk-about-cilium-and-how-it-leverages-ebpf-e36bfd98ff53)_. Medium.
- Linux Kernel Organization. (n.d.). _[BPF documentation](https://www.kernel.org/doc/html/latest/bpf/)_ [Documentation].
