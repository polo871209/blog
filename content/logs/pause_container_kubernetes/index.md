...
- Kubernetes Authors. (n.d.). _[Pods](https://kubernetes.io/docs/concepts/workloads/pods/)_ [Documentation].
- Lewis, I. (n.d.). _[The almighty pause container](https://www.ianlewis.org/en/almighty-pause-container)_.
- Kubernetes Authors. (n.d.). _[pause.c](https://github.com/kubernetes/kubernetes/blob/master/build/pause/linux/pause.c)_ [Source code]. GitHub.
- Kerrisk, M. (n.d.). _[namespaces(7) — Linux manual page](https://man7.org/linux/man-pages/man7/namespaces.7.html)_.
- Kerrisk, M. (n.d.). _[wait(2) — Linux manual page](https://man7.org/linux/man-pages/man2/wait.2.html)_.
