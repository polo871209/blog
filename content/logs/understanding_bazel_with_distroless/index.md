...
- Google. (n.d.). _[distroless](https://github.com/GoogleContainerTools/distroless)_ [Computer software]. GitHub.
- Bazel Authors. (n.d.). _[Bazel documentation](https://bazel.build/)_ [Documentation].
- Bazel Contrib. (n.d.). _[rules_oci](https://github.com/bazel-contrib/rules_oci)_ [Computer software]. GitHub.
- Google. (n.d.). _[rules_distroless](https://github.com/GoogleContainerTools/rules_distroless)_ [Computer software]. GitHub.
- Bazel Authors. (n.d.). _[Bazel modules](https://bazel.build/external/module)_ [Documentation].
- Debian Project. (n.d.). _[Debian snapshot archive](https://snapshot.debian.org/)_.
- Open Container Initiative. (n.d.). _[OCI image specification](https://github.com/opencontainers/image-spec)_ [Specification]. GitHub.
- Google. (n.d.). _[container-structure-test](https://github.com/GoogleContainerTools/container-structure-test)_ [Computer software]. GitHub.
